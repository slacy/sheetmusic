...
voicedefault =  {
  ...
  \repeat volta 2 {
    ...
    \times 2/3 { fs'16 g'16 a'16-4  }   \times 2/3 { g'16 fs'16    
				e'16  
			      }   \times 2/3 { d'16 e'16 d'16   }   \times 2/3 { c'16 b16 g16 }   |
    g16. b32 d'16. g'32 b'16. g'32 d'16. b32   |
    c'16. e'32 a'16. b'32 c''16. d''32 e''16. fs''32   |
    \grace { a''16   } g''16. fs''32 g''16. e''32   
    \times 2/3 { d''16 e''16-4 d''16   }   \times 2/3 { c''16 b'16 a'16 }   |
  ...
  \repeat volta 2 {
    b'16 (^\upbow c''16)   |
    d''16. g''32 (
    \grace { a''16 g''16   } fs''16 g''16) e''16. g''32 ( 		    \grace { a''16 g''16 } fs''16 g''16)   |
    ...
    \times 2/3 { a'16-4(g'16 fs'16)  }   \times 2/3 { a'16-4(g'16 e'16) } d'8-. b'16 (c''16)   |
    
    d''16. g''32 (\grace { a''16 g''16   } fs''16 g''16) e''16. g''32 (\grace { a''16 g''16 } fs''16 g''16)   |
    b''16. g''32 a''16. fs''32 g''16. e''32 d''16. b'32    |
