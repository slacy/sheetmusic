...
voicedefault =  {
  ...
  \repeat volta 2 {
    ...
    \time 2/4 
    \key g \major d''16^"Segno"^\downbow b'16 a'16 c''16 b'16 (g'16) g'8\turn    |
    b'8 (-. \grace { cs''16   		 } b'16) a'16 b'16 (d''16) g''16-. e''16-.   |
  ...
  \repeat volta 2 {
    ...
    g''8-. g''8\turn a''16-. g''16 (e''16) fs''16-.  |
    g''8 (-. \grace { a''16   		 } g''16) fs''16 g''16 a''16 b''16 g''16    |
