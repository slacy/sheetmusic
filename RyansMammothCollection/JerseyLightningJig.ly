...
voicedefault =  {
  ...
  \repeat volta 2 {
    ...
    \key a \minor
    e'8^\upbow |
    a'16.^\downbow(b'32-.) c''16. (d''32-.) e''16-4_\segue(a''16-4)   r16   
    e''16-2   |
    \grace { g''16-4 
	   } f''16.-3 e''32-2 
    ...
    \grace { g''16-4 
	   } f''16.-3 e''32 d''16. f''32 e''16-2(a''16-4)   r16 e''16-2   |
    \grace { g''16-4 
  ...
  \repeat volta 2 {
    ...
    c'''16.-3^\upbow(b''32-2-.) d'''16.-4^\downbow(c'''32-3)     
