...
voicedefault =  {
  ...
  \time 2/2 
  \key d \major d'8.^\downbow(d'16 -.)   \times 2/3 { fis'8 
						      ^\upbow(e'8 d'8) 
						    } fis'8.^\downbow(a'16 -.) d''8.^\upbow(
  a'16 -.)   |
  ...
  ^\downbow(fis'16 -.)   \grace { g'8^\upbow 
				}   \times 2/3 { fis'8 (
						 eis'8 fis'8) 
  ...
  \times 2/3 { b'8 (cis''8    
	       d''8) 
	     } a'8. cis''16 b'8. a'16 fis'8. a'16    |
