...
voicedefault =  {
  ...
  \repeat volta 2 {
    ...
    \override Score.SpacingSpanner #'common-shortest-duration = #(ly:make-moment 1 2)     b'16^\downbow-. e''16-. e''16-. cs''16 ( d''16) cs''16 (d''16) b'16-.   |
  ...
  \repeat volta 2 {
    \acciaccatura {
      fs''16  
    } e''16 ds''16 e''16 fs''16  \acciaccatura { a''16   					 } g''16 fs''16 g''16 e''16    |
    d''16-. e''16-. fs''16-. g''16 (a''16) fs''16 (d''16) fs''16-.  |
    e''16
    ds''16 e''16 fs''16 g''8-.   \times 2/3 { g''16 (fs''16 					      e''16)  					 }   |
