...
voicedefault =  {
  ...
  \repeat volta 2 {
    ...
    \time 2/4 
    \key a \major e'8^\downbow a'16 b'16 cs''32 e''16.-4   r16 e''16-0^\upbow    |
    fs''16 e''16 cs''16    
    e''16 a''8  \grace { gs''16   		       } a''8     |
  ...
  \repeat volta 2 {
    ...
    r8 e''8^\upbow e''4    |
    \times 2/3 { cs''16^\upbow(b'16 a'16) 
 	       } b'16 gs'16 a'16 cs''16 b'16 a'16     |
    e'8  
    \grace { gs''!16  
	   } a''8    r8 \grace { gs''16   			       } a''8^\upbow     |
