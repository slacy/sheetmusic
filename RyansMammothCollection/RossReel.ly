...
voicedefault =  {
  ...
  \repeat volta 2 {
    ...
    \time 2/4 
    \key e \major b'16^\downbow gs'16^\upbow  |
  ...
  \repeat volta 2 { ds''16^\downbow e''16^\upbow  |
		    
		    fs''16 b'16    \times 2/3 { b'16^\downbow(as'16 b'16) 
					      }   
		    gs''16^\upbow b'16    \times 2/3 { b'16^\upbow(as'16 b'16)  				      }     |
		    b''16^\downbow b'16 gs''16 b'16 fs''16 b'16    
		    \times 2/3 { b'16^\downbow(as'16 b'16)  	       }    |
