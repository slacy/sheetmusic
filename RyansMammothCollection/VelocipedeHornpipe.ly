...
voicedefault =  {
  ...
  \repeat volta 2 {     bes'8^"Segno"(d''8) f'8 (bes'8) d'8-. f'8-. bes'8-. d''8-.   |
    f''8 (bes''8) d''8 (f''8) bes'8-. d''8-. f'8-. bes'8-.       |
    c''8 (ees''8) c''8 (bes'8) a'8-. f'8-. c'8-. f'8-.   |
    a'8-. f'8-. c''8-. a'8-.        a''8 (g''8) ees''8 (c''8)   |  |
    ...
    d''4 f'4   >> << bes'4 d'4   >> f'4        
		     ...
		     \repeat volta 2 {
		       ...
		       \times 2/3 { f''8 (g''8 a''8) 
				      ...
				      bes'8)       
				    } { f''8 (e''8 f''8 g''8) f''8 (ees''!8     					c''8 a'8)     \bar " |."   
				      }
				  }
