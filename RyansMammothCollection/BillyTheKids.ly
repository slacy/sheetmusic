...
voicedefault =  {
  ...
  \repeat volta 2 {
    ...
    r16.      a32^\upbow cis'16.^\downbow(e'32-.) a'4-4^\upbow    |
    
    b'16. (a'32-.) gis'16. (b'32-.) a'16. (cis''32-.)        e''16. (a''32-.)  |
  ...
  \repeat volta 2 {
    ...
    a''16.^\downbow g''32^\upbow        e''16.^\upbow(fis''32-.) g''4     |
    \times 2/3 { g'16 
		^\downbow b'16 d''16   	       } gis''16. (a''32-.) gis''4     |
    
    \times 2/3 { b'16^\upbow d''16 g''16  
	       } a''16. (b''32-.)        a''4     |
    a''16^\downbow a'16    r16 a''16^\upbow a''16         a'16    r16 a''16^\upbow    |
    a''16.^\downbow g''32^\upbow        e''16. (fis''32-.) g''4     |
    a''16.^\downbow fis''32         g''16. e''32 fis''16. d''32 e''16.-4 d''32     |
