...
voicedefault =  {
 ...
 g''16. (a''32-.) fs''16. (g''32-.) e''16. (cs''32-.)   
  ...
  } \alternative{{ d''16. (fs''32-.) e''16. (cs''32-.) 
		 } {    		 d''16. (b'32-.) a'16. (g'32-.) fs'16 d'16  \bar " |."   
		 }
	       }
